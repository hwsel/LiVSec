...
from ProtectedFaceGeneration.modules.data_module import AttackFaceIDDataModule
...
def main(args):
    ...
    checkpoint = ModelCheckpoint(
        monitor="attack_accuracy/val", mode="max", save_last=True
    )
    ...
    model = AttackFaceIDModule(args)
    data = AttackFaceIDDataModule(args)
